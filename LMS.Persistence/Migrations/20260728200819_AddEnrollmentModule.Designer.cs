...
namespace LMS.Persistence.Migrations
{
    ...
    [Migration("20260728200819_AddEnrollmentModule")]
            ...
            modelBuilder.Entity("LMS.Domain.Entities.Enrollments.Enrollment", b =>
                {
                    ...
                    b.Property<bool>("IsCertificateEligible")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("LMS.Domain.Entities.Enrollments.Enrollment", b =>
                {
                    ...
                    b.HasOne("LMS.Domain.Entities.Commerce.Orders.OrderItem", "OrderItem")
                        .WithOne("Enrollment")
                        .HasForeignKey("LMS.Domain.Entities.Enrollments.Enrollment", "OrderItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
