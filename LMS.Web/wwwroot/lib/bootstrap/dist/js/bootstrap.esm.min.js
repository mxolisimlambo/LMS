...
class Carousel extends BaseComponent {
    ...
    _slide(e, t) {
        ...
        const E = () => {
            EventHandler.trigger(this._element, EVENT_SLID, { relatedTarget: o, direction: h, from: s, to: r });
        };
...
const uriAttrs = new Set(['background', 'cite', 'href', 'itemtype', 'longdesc', 'poster', 'src', 'xlink:href']),
    ...
    allowedAttribute = (e, t) => {
        ...
        if (t.includes(i))
            return (
                !uriAttrs.has(i) || Boolean(SAFE_URL_PATTERN.test(e.nodeValue) || DATA_URL_PATTERN.test(e.nodeValue))
            );
